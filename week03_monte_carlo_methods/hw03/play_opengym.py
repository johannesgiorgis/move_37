...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None):
    ...
    while running:
        ...
        if env_done:
            ...
            print(f'\nCounter:{counter}')
            print(obs)
            print(f"Obs Low:{env.observation_space.low}|Obs High:{env.observation_space.high}")
            print(f"\nCounter:{counter}|Reward:{rew}|Env_done?:{env_done}")
